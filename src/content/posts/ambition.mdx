...
export const metadata = {
  ...
  excerpt: "On learning to say no to opportunity in service of something deeper",
};

<CaptionedImage
  src="/essays/ambition/stone-pines.webp"
...
<CaptionedImage
  src="/essays/ambition/misty.webp"
...
<CaptionedImage
  src="/essays/ambition/view-from-loop-office.webp"
...
<CaptionedImage
  src="/essays/ambition/me-with-the-prem.webp"
  alt="Alé standing with the Premier of the Western Cape"
  title="Me with the Premier of the Western Cape (right) and the then head of Mitchells Plain Ricardo Mackenzie"
/>{" "}
...
<CaptionedImage
  src="/essays/ambition/saunders-at-sunset.webp"
...
<CaptionedImage
  src="/essays/ambition/blonde-hair.webp"
  alt="Alé with blonde hair"
/>

<CaptionedImage
  src="/essays/ambition/handstand.webp"
...
<CaptionedImage
  src="/essays/ambition/southern-suburbs-view.webp"
...
<CaptionedImage
  src="/essays/ambition/have-fun-at-rehab.webp"
...
*<span style={{ fontSize: '0.9rem' }}>I'm actually writing this many months deep into my time in the UK, so I know what awaits :P. All I'll say for now is that it didn't quite go according to plan, but in a… good way. Maybe I'll write about the rest at some point.</span>*